...
void uart_init(){
	...
	MODIFY_REG(GPIOB->AFR, GPIO_AFRL_AFSEL6_3, (GPIO_AFRL_AFSEL6_0 | GPIO_AFRL_AFSEL6_1 | GPIO_AFRL_AFSEL6_2));	
	MODIFY_REG(GPIOB->AFR, GPIO_AFRL_AFSEL7_3, (GPIO_AFRL_AFSEL7_0 | GPIO_AFRL_AFSEL7_1 | GPIO_AFRL_AFSEL7_2));	
	...
	//Passage en 8N1
	CLEAR_BIT(USART1->CR1, (USART_CR1_M0 | USART_CR1_M1));
